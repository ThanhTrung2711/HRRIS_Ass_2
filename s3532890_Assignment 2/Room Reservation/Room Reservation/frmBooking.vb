...
Public Class frmBooking
    ...
    Private Sub populateFormFields(ByVal htdata As Hashtable)
        txtdate.Text = CStr(CDate(htdata("title")))
        cboRoomid.Text = CStr(CInt(htdata("gender")))
        txtcusid.Text = CStr(CInt(htdata("firstname")))
        txtnumday.Text = CStr(CInt(htdata("lastname")))
        txtnumguest.Text = CStr(CInt(htdata("phone")))
        txtcheckinday.Text = CStr(CDate(htdata("address")))
        txttotalprice.Text = CStr(CInt(htdata("email")))
        txtcomment.Text = CStr(CDate(htdata("dob")))
    End Sub
End Class