...
Public Class BookingDataController
   ...
   "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=RoomReservationDB.accdb"
    ''This function will insert Booking data into database 
    ...
    'This function will find any Booking based on booking id 
    ...
    End Function
    ''This function will update any booking details 
    Public Function updateBookId(ByVal htData1 As Hashtable) As Integer
        ...
        Return iNumRows
    End Function
    'This function will delete any Booking based on booking id 
    Public Function deleteBooking(ByVal sId As String) As Integer
        ...
        Return iNumRows
    End Function
    'This function will find all Booking based on booking id 
