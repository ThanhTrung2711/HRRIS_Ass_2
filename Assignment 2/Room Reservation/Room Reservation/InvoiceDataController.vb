...
Public Class InvoiceDataController
   ...
   "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=RoomReservationDB.accdb"
    'This will insert invoice data into the database
    ...
    End Function
    'This function will populate only the the total price from Booking form and use to show on the invoice form
